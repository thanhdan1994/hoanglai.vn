                ...
                <section class="boxShadow">
                    <div class="title line-blue">
                        <a href="javascript: void(0)">
                            <img src="/img/cartridge-category-icon-64x64.png" alt="icon cartridge">
                            <span class="font15 text-center">DANH SÁCH MỰC IN TẠI HOÀNG LAI</span>
                        </a>
                    </div>
...
@section('js')
    <script>
        ...
        buttonLoadMore.addEventListener('click', function () {
            ...
            xhttp.open("GET", "/api/products?category=3&page="+nextPage, true);
            xhttp.send();
        });
    </script>
@endsection
