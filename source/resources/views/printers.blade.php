                ...
                <section class="boxShadow">
                    <div class="title line-blue">
                        <a href="javascript: void(0)">
                            <img src="/img/printer-category-icon-64x64.png" alt="icon printer">
                            <span class="font15 text-center">DANH SÁCH MÁY IN TẠI HOÀNG LAI</span>
                        </a>
                    </div>
...
@section('js')
    <script>
        ...
        buttonLoadMore.addEventListener('click', function () {
            ...
            xhttp.open("GET", "/api/products?category=1&page="+nextPage, true);
            xhttp.send();
        });
    </script>
@endsection
