                            ...
                            <form method="POST" action="{{ route('vendors.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" placeholder="Nhập vào tên nhà cung cấp" value="{{ old('name') }}">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group col-xs-12">
                                            <span data-thumbnail="{{ env('APP_URL') . '/' . 'default.jpg' }}" class="input-group-append file-upload-browse logo" style="background: url({{ env('APP_URL') . '/' . 'default.jpg' }})">
                                            </span>
                                        </div>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" name="printer_flg" checked data-bootstrap-switch>
                                        <label class="form-check-label">Hiển thị tại mục máy in</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" name="photocopy_flg" checked data-bootstrap-switch>
                                        <label class="form-check-label">Hiển thị tại mục máy photocopy</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" name="cartridge_flg" checked data-bootstrap-switch>
