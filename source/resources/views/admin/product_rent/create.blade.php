    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Thêm máy photocopy cho thuê</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="=/">Dashboard</a></li>
                            <li class="breadcrumb-item active">Thêm máy photocopy cho thuê</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Thêm máy photocopy cho thuê</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form method="POST" action="{{ route('product-rent.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    @if ($errors->any())
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="price_rent" value="{{ old('price_rent') }}" id="product-price" class="form-control" placeholder="Nhập vào số sản phẩm">
                                    </div>
