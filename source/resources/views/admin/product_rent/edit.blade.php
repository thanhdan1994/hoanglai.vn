                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form method="POST" action="{{ route('product-rent.update', $product->id) }}" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                <div class="card-body">
                                    @if ($errors->any())
                                    ...
                                    <div class="form-group">
                                        <label for="inputProductPrice">Giá cho thuê <span style="color: red;"><i>(*)</i></span></label>
                                        <input type="text" name="price_rent" id="product-price" class="form-control" placeholder="Nhập vào số sản phẩm" value="{{ number_format($product->price_rent) }}">
                                    </div>
